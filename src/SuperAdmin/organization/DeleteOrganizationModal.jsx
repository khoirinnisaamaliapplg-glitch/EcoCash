      ...
      <DialogBody className="px-8 py-4">
        <div className="flex flex-col items-center text-center">
          ...
          <Typography className="text-blue-gray-700">
            ...
            organization berikut?
          </Typography>

          <Typography className="mt-3 text-lg font-bold text-blue-gray-900">
            {organization?.name || "-"}
          </Typography>
          ...
          >
            Organization akan dinonaktifkan dan
            tidak lagi ditampilkan pada daftar
            organization aktif.
          </Typography>
        </div>
      </DialogBody>
