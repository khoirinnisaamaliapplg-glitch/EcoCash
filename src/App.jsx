...
const App = () => {
  ...
  return (
    // Background utama sekarang langsung putih, tanpa pembatas abu-abu di luar
    <div className="min-h-screen bg-white flex flex-col md:flex-row overflow-hidden">
      
      {/* --- SISI KIRI: HERO (Biru Muda) --- */}
      <div className="w-full md:w-1/2 bg-[#e8f5ff] p-10 flex flex-col items-center justify-center text-center">
        <img 
          src="/login.png" // Ganti dengan aset EcoCash kamu
